...
bool Mp4HeaderParser::parser()
{
	...
	// 测试
	int arrayIndex[] = { 5330,  100, 500, 1000, 3000, 5300};
	for (int i = 0; i < 6; i++)
	{
...
uint32_t Mp4HeaderParser::getOffsetByTime(uint32_t seconds)
{
	...
	mp4_stts_box stts = mMoovBox.trak[0]->mdia.minf.stbl.stts;
	...
	mp4_stsc_box stsc = mMoovBox.trak[0]->mdia.minf.stbl.stsc;
	...
	mp4_stco_box stco = mMoovBox.trak[0]->mdia.minf.stbl.stco;
